...
- Preserve distinct bold and italic styles when adjacent elements are merged,
  including elements wrapped in transparent inline containers.
- Insert invisible inline comments (`<!-- -->`) where needed to separate
  generated emphasis delimiters at adjacent runs and punctuation boundaries,
  without adding visible spaces.
- Preserve literal backslashes and entity spellings in link and image titles.
...
- Normalize CR, LF and CRLF in link/image titles and image alt text to spaces.
